...
class NodeOutputKeyUsage:
    ...
    def __repr__(self) -> str:
        ...
        return f"NodeOutputKeyUsage(invocation_id={self._invocation_id}, output_name={self._output_name}, key_name={self._key_name}, serializer={self._serializer}, is_partitioned={self._is_partitioned})"
