...
def prepare_datasets(sample_size):
    """ Mocks the preparation of training and test datasets. """
...
def measure_model_performance(model, test_dataset):
    """ Measures the model performance in the test dataset. """
    return "performance report"


@dsl.DAG()
def dag(sample_size):
    """ Defines the DAG, i.e. the dependencies between the tasks. """
